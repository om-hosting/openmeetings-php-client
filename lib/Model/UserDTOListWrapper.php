...
/**
 * UserDTOListWrapper Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UserDTOListWrapper implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UserDTOListWrapper';
    ...
    protected static $swaggerTypes = [
        'user_dto' => '\Swagger\Client\Model\UserDTO[]'    ];
    ...
    {
        $this->container['user_dto'] = isset($data['user_dto']) ? $data['user_dto'] : null;
    }
    ...
    {
        return $this->container['user_dto'];
    }

    /**
     * Sets user_dto
     *
     * @param \Swagger\Client\Model\UserDTO[] $user_dto user_dto
     *
     * @return $this
     */
    public function setUserDto($user_dto)
    {
        $this->container['user_dto'] = $user_dto;
