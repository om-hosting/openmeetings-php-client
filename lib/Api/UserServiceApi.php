...
class UserServiceApi
{
    ...
    /**
     * Operation add3AsyncWithHttpInfo
     *
     * 
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
    ...
    protected function add3Request($sid, $body = null)
    {
        ...
        if ($sid === null || (is_array($sid) && count($sid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sid when calling add3'
            );
        }
     ...
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
     * @param  int $id the openmeetings user id (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    {
        list($response) = $this->delete5WithHttpInfo($sid, $id);
        return $response;
    }

    /**
     * Operation delete5WithHttpInfo
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
     * @param  int $id the openmeetings user id (required)
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function delete5Async($sid, $id)
    {
        return $this->delete5AsyncWithHttpInfo($sid, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation delete5AsyncWithHttpInfo
     *
     * 
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
    ...
    /**
     * Create request for operation 'delete5'
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
     * @param  int $id the openmeetings user id (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function delete5Request($sid, $id)
    {
        // verify the required parameter 'sid' is set
        if ($sid === null || (is_array($sid) && count($sid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sid when calling delete5'
            );
        }
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling delete5'
            );
        }
    ...
    /**
     * Operation deleteExternal1
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
     * @param  string $externaltype externalUserId (required)
     * @param  string $externalid externalType (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ServiceResultWrapper
    ...
    {
        list($response) = $this->deleteExternal1WithHttpInfo($sid, $externaltype, $externalid);
        return $response;
    }

    /**
     * Operation deleteExternal1WithHttpInfo
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
     * @param  string $externaltype externalUserId (required)
     * @param  string $externalid externalType (required)
    ...
    /**
     * Operation deleteExternal1Async
     *
     * 
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteExternal1Async($sid, $externaltype, $externalid)
    {
        return $this->deleteExternal1AsyncWithHttpInfo($sid, $externaltype, $externalid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteExternal1AsyncWithHttpInfo
     *
     * 
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
    ...
    /**
     * Create request for operation 'deleteExternal1'
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
     * @param  string $externaltype externalUserId (required)
     * @param  string $externalid externalType (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteExternal1Request($sid, $externaltype, $externalid)
    {
        // verify the required parameter 'sid' is set
        if ($sid === null || (is_array($sid) && count($sid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sid when calling deleteExternal1'
            );
        }
        // verify the required parameter 'externaltype' is set
        if ($externaltype === null || (is_array($externaltype) && count($externaltype) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $externaltype when calling deleteExternal1'
            );
        }
        // verify the required parameter 'externalid' is set
        if ($externalid === null || (is_array($externalid) && count($externalid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $externalid when calling deleteExternal1'
            );
        }

        $resourcePath = '/user/{externaltype}/{externalid}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->get3WithHttpInfo($sid);
        return $response;
    }

    /**
     * Operation get3WithHttpInfo
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function get3Async($sid)
    {
        return $this->get3AsyncWithHttpInfo($sid)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation get3AsyncWithHttpInfo
     *
     * 
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
    ...
    /**
     * Create request for operation 'get3'
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function get3Request($sid)
    {
        // verify the required parameter 'sid' is set
        if ($sid === null || (is_array($sid) && count($sid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sid when calling get3'
            );
        }
    ...
    /**
     * Operation getRoomHashAsyncWithHttpInfo
     *
     * 
     *
     * @param  string $sid The SID of the User. This SID must be marked as Loggedin (required)
    ...
    protected function getRoomHashRequest($sid, $options = null, $user = null)
    {
        ...
        if ($sid === null || (is_array($sid) && count($sid) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sid when calling getRoomHash'
            );
        }

        $resourcePath = '/user/hash';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * Operation login
     *
     * @param  string $user login or email of Openmeetings user with admin or SOAP-rights (required)
     * @param  string $pass password (required)
     *
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\ServiceResultWrapper
    ...
    {
        list($response) = $this->loginWithHttpInfo($user, $pass);
        return $response;
    }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function loginAsync($user, $pass)
    {
        return $this->loginAsyncWithHttpInfo($user, $pass)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function loginRequest($user, $pass)
    {
        // verify the required parameter 'user' is set
        if ($user === null || (is_array($user) && count($user) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $user when calling login'
            );
        }
        // verify the required parameter 'pass' is set
        if ($pass === null || (is_array($pass) && count($pass) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $pass when calling login'
            );
        }
        ...
        // query params
        if ($pass !== null) {
            $queryParams['pass'] = ObjectSerializer::toQueryValue($pass, null);
        }
